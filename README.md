...
* **Index**:
    ...
    * Random Product Cards **(Clickable)**
...
* **Index**:
    ...
    * Random generation of Trending cards
    * Random generation of Random cards
...
* **Product**:
    * Update size category **(US5, US6, etc..)**
...
* **Games**:
    * Implement pay to play functionality
...
## Credits ##
### Content ###
- [Draftbit API](https://example-data.draftbit.com/) → Sneaker API used to gather data.
- [Winwheel JS Library](http://dougtesting.net/winwheel/docs) → Download WinWheel JS Library.
